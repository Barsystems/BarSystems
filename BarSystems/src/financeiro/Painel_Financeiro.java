...
public class Painel_Financeiro extends javax.swing.JPanel {
    ...
    public void carregaLancamentos() {
        ...
        if (flagReceita == 1) {
            ...
            valor_receitas = receitas.carregaReceitas(liquidado, data_de, data_ate, modelo);
        }
        ...
        if (flagDespesa == 1) {
            ...
            valor_despesas = despesas.carregaDespesas(liquidado, data_de, data_ate, modelo);
        }
    ...
    private void initComponents() {
        ...
        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Trocar usuário 16px.png"))); // NOI18N
        ...
        jScrollPane4.setBounds(20, 150, 960, 300);
        ...
        btnAlterarLancamentos.setBounds(380, 500, 130, 30);
        ...
        btnNovoLancamentos.setBounds(240, 500, 130, 30);
        ...
        btnExcluirLancamentos.setBounds(520, 500, 130, 30);
        ...
        btnSairLancamentos.setBounds(660, 500, 130, 30);

        jLabel35.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel35.setForeground(new java.awt.Color(255, 0, 0));
        jLabel35.setText("Total de receitas liquidadas:");
        Lancamentos.getContentPane().add(jLabel35);
        jLabel35.setBounds(20, 460, 160, 15);
        ...
        lblTotalReceitas.setBounds(200, 460, 100, 15);

        jLabel37.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel37.setForeground(new java.awt.Color(255, 0, 0));
        jLabel37.setText("Total de despesas liquidadas:");
        Lancamentos.getContentPane().add(jLabel37);
        jLabel37.setBounds(410, 460, 170, 15);
        ...
        lblTotalDespesas.setBounds(600, 460, 100, 15);
        ...
        jLabel39.setBounds(810, 460, 80, 15);
        ...
        lblValorTotal.setBounds(890, 460, 100, 15);
        ...
        btnSalvarNovoLancamento.setBounds(180, 360, 100, 30);
        ...
        btnLimpar.setBounds(290, 360, 100, 30);
        ...
        btnSairNovoLancamento.setBounds(400, 360, 100, 30);
        ...
        jLabel34.setBounds(90, 300, 520, 17);
    ...
    private void btnNovoLancamentosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoLancamentosActionPerformed
        ...
        Agendar_Lancamento.setBounds(0, 0, 670, 440);
        ...
        if (txtDescricaoNovoLancamento.getText().isEmpty()) {
            ...
            if (comboTipoNovoLancamento.getSelectedItem().toString().equals("Receita")) {
                ...
                receitas.cadastraReceita(txtDescricaoNovoLancamento.getText(), 0, "", "Entrada na conta bancária", forma,
                    ...
                    Integer.valueOf(comboParcelasNovoLancamento.getSelectedItem().toString()), 0, 0, data, data, 0, 1);
                ...
                despesas.cadastraDespesa(0, txtDescricaoNovoLancamento.getText(), nome_usuario, "", 
                    Integer.valueOf(comboParcelasNovoLancamento.getSelectedItem().toString()), data, data, forma,
                    txtValorNovoLancamento.getText(), "0", "0", 0, 1, "Saída na conta bancária", id_usuario, 0, 0, 0, 1);
            }

            carregaLancamentos();
            JOptionPane.showMessageDialog(null, "Lançamento agendado com sucesso! Lembre-se que este é um lançamento não liquidado,\nou seja, é preciso acessar os centros de custo para liquidá-los depois!", "Atenção", JOptionPane.INFORMATION_MESSAGE);
