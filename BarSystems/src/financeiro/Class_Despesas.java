...
public class Class_Despesas {
    ...
    public float carregaDespesas(String situacao, String data_de, String data_ate, DefaultTableModel tabela) {
    ...
    public void liquidarDespesaPelaMovimentacaoCaixa(int id_movimentacao_caixa, int id_despesa, String data_pagamento) {
        try {
            Class_Conexao_Banco banco = new Class_Conexao_Banco();
            Connection conn = banco.getConexaoMySQL();
            PreparedStatement ps = conn.prepareStatement("UPDATE despesas SET "
