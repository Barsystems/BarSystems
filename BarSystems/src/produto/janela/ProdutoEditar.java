...
public class ProdutoEditar extends JDialog implements ActionListener, KeyListener {
    ...
    private JLabel lblTitulo, lblNome, lblSetor, lblValorCompra, lblPorcentagemVenda, lblValorVenda;
    private JTextField txtNome, txtValorCompra, txtPorcentagemVenda, txtValorVenda;
    ...
    public ProdutoEditar(ProdutoClasse prod) {
        ...
        painel2.setBounds(0, 60, 500, 250);
        ...
        painel3.setBounds(0, 320, 500, 100);
