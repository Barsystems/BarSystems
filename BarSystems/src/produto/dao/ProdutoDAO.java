...
public class ProdutoDAO implements IProdutoDAO {
    ...
    private static final String SQL_SAVE = "INSERT INTO produto (nome, id_setor_fk, valor_compra, valor_venda) "
            + "VALUES (?, ?, ?, ?)";
    ...
    private static final String SQL_FIND_ALL = "SELECT produto.id_produto, produto.nome, produto.id_setor_fk, "
            + "produto.valor_compra, produto.valor_venda, produto_setor.nome "
            + "FROM produto "
