...
public class Painel_Fornecedores extends javax.swing.JPanel {
    ...
    protected String razao_social, nome_fantasia;
    protected JTabbedPane painel_principal;
    
    public Painel_Fornecedores(JTabbedPane painelPrincipal) {
        initComponents();
    ...
    public void refreshCampos(){
        ...
        forn.carregaFornecedor((String) lista_fornecedores.getSelectedValue());
        nome_fornecedor.setText(forn.getRazao_social());
        fantasia_fornecedor.setText(forn.getNome_fantasia());
        cnpj_fornecedor.setText(forn.getCnpj());
        cidade_fornecedor.setText(forn.getCidade());
        estado_fornecedor.setText(forn.getEstado());
        endereco_fornecedor.setText(forn.getEndereco());
        bairro_fornecedor.setText(forn.getBairro());
        telefone_fornecedor.setText(forn.getTelefone());
        email_fornecedor.setText(forn.getEmail());
        inscricao_fornecedor2.setText(forn.getInscricao_estadual());
        id_fornecedor = forn.getId_fornecedor();
    }
    
    public void carregaEditar() {
        Class_Fornecedores fornecedor = new Class_Fornecedores();
        fornecedor.carregaFornecedor((String) lista_fornecedores.getSelectedValue());
        id_fornecedor = fornecedor.getId_fornecedor();
        nome_fornecedor2.setText(fornecedor.getRazao_social());
        razao_social = nome_fornecedor2.getText();
        fantasia_fornecedor2.setText(fornecedor.getNome_fantasia());
        nome_fantasia = fantasia_fornecedor2.getText();
        cnpj_fornecedor2.setText(fornecedor.getCnpj());
        cidade_fornecedor2.setText(fornecedor.getCidade());
        estado_fornecedor2.setText(fornecedor.getEstado());
        endereco_fornecedor2.setText(fornecedor.getEndereco());
        bairro_fornecedor2.setText(fornecedor.getBairro());
        telefone_fornecedor2.setText(fornecedor.getTelefone());
        email_fornecedor2.setText(fornecedor.getEmail());
        inscricao_fornecedor3.setText(fornecedor.getInscricao_estadual());
        obs_fornecedor2.setText(fornecedor.getObservacoes());
    }
    ...
    private void initComponents() {
        ...
        btnSalvarEdicaoFornecedor = new javax.swing.JButton();
        btnCancelarEdicaoFornecedor = new javax.swing.JButton();
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Fornecedor 24px.png"))); // NOI18N
        ...
        btnSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Salvar 16px.png"))); // NOI18N
        ...
        jLabel36.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Fornecedor 24px.png"))); // NOI18N
        jLabel36.setText("Editar fornecedor");
        edita_fornecedor.getContentPane().add(jLabel36);
        jLabel36.setBounds(0, 30, 580, 29);

        btnSalvarEdicaoFornecedor.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btnSalvarEdicaoFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Salvar 16px.png"))); // NOI18N
        btnSalvarEdicaoFornecedor.setText("Salvar");
        btnSalvarEdicaoFornecedor.setToolTipText("Finalizar a edição das informações do fornecedor");
        btnSalvarEdicaoFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSalvarEdicaoFornecedorActionPerformed(evt);
            }
        });
        edita_fornecedor.getContentPane().add(btnSalvarEdicaoFornecedor);
        btnSalvarEdicaoFornecedor.setBounds(190, 460, 100, 30);

        btnCancelarEdicaoFornecedor.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btnCancelarEdicaoFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Sair02 16px.png"))); // NOI18N
        btnCancelarEdicaoFornecedor.setText("Sair");
        btnCancelarEdicaoFornecedor.setToolTipText("Cancelar edição das informações do fornecedor");
        btnCancelarEdicaoFornecedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCancelarEdicaoFornecedorActionPerformed(evt);
            }
        });
        edita_fornecedor.getContentPane().add(btnCancelarEdicaoFornecedor);
        btnCancelarEdicaoFornecedor.setBounds(300, 460, 100, 30);
        ...
        lbl_fornecedores.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Fornecedor 24px.png"))); // NOI18N
        ...
        btnObservacoes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Pesquisar 16px.png"))); // NOI18N
        btnObservacoes.setToolTipText("Clique para ampliar as observações do fornecedor");
        ...
        btnFecharTela.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Sair02 16px.png"))); // NOI18N
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        {
            Class_Fornecedores fornecedor = new Class_Fornecedores();
            if (fornecedor.verificaComprasFornecedor(id_fornecedor) == true) {
                JOptionPane.showMessageDialog(null, "Este fornecedor não pode ser excluído pois existe uma compra em seu nome!", "Atenção", JOptionPane.WARNING_MESSAGE);
            }
            else if (JOptionPane.showConfirmDialog(null, "Deseja realmente excluir o fornecedor "+nome_fornecedor.getText()+"?", "Atenção", JOptionPane.YES_NO_OPTION)==0)
            {
                fornecedor.exclui(id_fornecedor);
                refreshList();
            }
        }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if(nome_fornecedor1.getText().equals("") || fantasia_fornecedor1.getText().equals("") ||
            cnpj_fornecedor1.getText().equals("") || cidade_fornecedor1.getText().equals("") ||
            estado_fornecedor1.getText().equals("") || endereco_fornecedor1.getText().equals("") ||
            bairro_fornecedor1.getText().equals("") || telefone_fornecedor1.getText().equals("") ||
            email_fornecedor1.getText().equals("") || inscricao_fornecedor1.getText().equals("") ||
        ...
        {
            Class_Fornecedores fornecedor = new Class_Fornecedores();
            if (fornecedor.verificaRazaoSocialRepetidaFornecedor(nome_fornecedor1.getText()) == true) {
                JOptionPane.showMessageDialog(null, "Já existe um fornecedor com esta razão social!", "Atenção", JOptionPane.WARNING_MESSAGE);
                nome_fornecedor1.grabFocus();
                nome_fornecedor1.selectAll();
            } else if (fornecedor.verificaNomeFantasiaRepetidaFornecedor(fantasia_fornecedor1.getText()) == true) {
                JOptionPane.showMessageDialog(null, "Já existe um fornecedor com este nome fantasia!", "Atenção", JOptionPane.WARNING_MESSAGE);
                fantasia_fornecedor1.grabFocus();
                fantasia_fornecedor1.selectAll();
            } else {
                fornecedor.Cadastra(nome_fornecedor1.getText(), fantasia_fornecedor1.getText(), cnpj_fornecedor1.getText(),
                cidade_fornecedor1.getText(), estado_fornecedor1.getText(), endereco_fornecedor1.getText(),
                bairro_fornecedor1.getText(), telefone_fornecedor1.getText(), email_fornecedor1.getText(),
                inscricao_fornecedor1.getText(), obs_fornecedor1.getText());
    ...
    private void btnSalvarEdicaoFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarEdicaoFornecedorActionPerformed
        
        if (nome_fornecedor2.getText().equals("") || fantasia_fornecedor2.getText().equals("") ||
            cnpj_fornecedor2.getText().equals("") || cidade_fornecedor2.getText().equals("") ||
            estado_fornecedor2.getText().equals("") || endereco_fornecedor2.getText().equals("") ||
            bairro_fornecedor2.getText().equals("") || telefone_fornecedor2.getText().equals("") ||
            email_fornecedor2.getText().equals("") || inscricao_fornecedor3.getText().equals("") ||
            obs_fornecedor2.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Nao pode haver campos vazios!");
        }
        else {
            Class_Fornecedores fornecedor = new Class_Fornecedores();
            boolean flag = fornecedor.verificaComprasFornecedor(id_fornecedor);
            if (!razao_social.equals(nome_fornecedor2.getText()) && flag == true) {
                JOptionPane.showMessageDialog(null, "A razão social deste fornecedor não pode ser alterado,\npois há uma compra em seu nome!", "Atenção", JOptionPane.WARNING_MESSAGE);
                nome_fornecedor2.grabFocus();
                nome_fornecedor2.selectAll();
            }
            else if (!nome_fantasia.equals(fantasia_fornecedor2.getText()) && flag == true) {
                JOptionPane.showMessageDialog(null, "O nome fantasia deste fornecedor não pode ser alterado,\npois há uma compra em seu nome!", "Atenção", JOptionPane.WARNING_MESSAGE);
                fantasia_fornecedor2.grabFocus();
                fantasia_fornecedor2.selectAll();
            } else if (!razao_social.equals(nome_fornecedor2.getText()) && fornecedor.verificaRazaoSocialRepetidaFornecedor(nome_fornecedor2.getText())) {
                JOptionPane.showMessageDialog(null, "Já existe um fornecedor com esta razão social!", "Atenção", JOptionPane.WARNING_MESSAGE);
                nome_fornecedor2.grabFocus();
                nome_fornecedor2.selectAll();
            } else if (!nome_fantasia.equals(fantasia_fornecedor2.getText()) && fornecedor.verificaNomeFantasiaRepetidaFornecedor(fantasia_fornecedor2.getText())) {
                JOptionPane.showMessageDialog(null, "Já existe um fornecedor com este nome fantasia!", "Atenção", JOptionPane.WARNING_MESSAGE);
                fantasia_fornecedor2.grabFocus();
                fantasia_fornecedor2.selectAll();
            } else {
                fornecedor.edita (nome_fornecedor2.getText(), fantasia_fornecedor2.getText(),
                    cnpj_fornecedor2.getText(), cidade_fornecedor2.getText(), estado_fornecedor2.getText(),
                    endereco_fornecedor2.getText(), bairro_fornecedor2.getText(), telefone_fornecedor2.getText(),
                    email_fornecedor2.getText(), inscricao_fornecedor3.getText(), obs_fornecedor2.getText(), id_fornecedor); 

                JOptionPane.showMessageDialog(null, "Fornecedor editado com sucesso!", "Atenção", JOptionPane.INFORMATION_MESSAGE);
                refreshList();
                edita_fornecedor.dispose();
            }
        }
    }//GEN-LAST:event_btnSalvarEdicaoFornecedorActionPerformed

    private void btnCancelarEdicaoFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarEdicaoFornecedorActionPerformed
        
        edita_fornecedor.setVisible(false);
        
    }//GEN-LAST:event_btnCancelarEdicaoFornecedorActionPerformed
    ...
    private javax.swing.JButton btnCancelarEdicaoFornecedor;
    ...
    private javax.swing.JButton btnSalvarEdicaoFornecedor;
