 ...
 */
package conta_bancaria_movimentacao.table;
 ...
 * @author Marcos
 */
public class ContaBancariaMovimentacaoTableModel extends AbstractTableModel {
    ...
    private List<ContaBancariaMovimentacaoClasse> valores;
    
    public ContaBancariaMovimentacaoTableModel(List<ContaBancariaMovimentacaoClasse> valores) {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ContaBancariaMovimentacaoClasse classe = valores.get(rowIndex);
    ...
    public ContaBancariaMovimentacaoClasse get(int row) {
