 ...
 * @author Marcos
 */
public class FormaPagamentoMaquinaCartaoCadastrar extends JDialog implements ActionListener {
    ...
    public FormaPagamentoMaquinaCartaoCadastrar() {
    ...
    public void salvar() {
        if (txtNome.getText().isEmpty()) {
            ...
            if (cont.verificaMaquinaCartaoRepetida(txtNome.getText()) == true) {
                ...
                FormaPagamentoMaquinaCartaoClasse classe = new FormaPagamentoMaquinaCartaoClasse();
                classe.setNome(txtNome.getText());
                
                int result = cont.addMaquinaCartao(classe);
                if (result == 1) {
                    JOptionPane.showMessageDialog(null, "Máquina de cartão "+txtNome.getText()+" cadastrada com sucesso!", "ATENÇÃO", JOptionPane.INFORMATION_MESSAGE);
                    cadastrou = true;
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Falha ao tentar cadastrar a máquina de cartão "+txtNome.getText()+"!", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
