 ...
 * @author Marcos
 */
public class EmpresaEditar extends JDialog implements ActionListener {
    ...
    private EmpresaClasse empresa;
    
    public boolean editou = false;
    
    public EmpresaEditar(EmpresaClasse empresa) throws ParseException {
        ...
        txtRazaoSocial.setText(this.empresa.getRazao_social());
        ...
        txtNomeFantasia.setText(this.empresa.getNome_fantasia());
        ...
        txtCnpj.setText(this.empresa.getCnpj());
        ...
        txtEmail.setText(this.empresa.getEmail());
        ...
        txtTelefone.setText(this.empresa.getTelefone());
        ...
        txtInscricaoEstadual.setText(this.empresa.getInscricao_estadual());
        ...
        txtObservacao.setText(this.empresa.getObservacao());
        ...
        txtCep.setText(this.empresa.getCep());
        ...
        txtEstado.setText(this.empresa.getEstado());
        ...
        for (int i = 0; i < lista_paises.size(); i++) {
            if (lista_paises.get(i).getId().equals(this.empresa.getId_Pais())) {
    ...
    public void salvar() {
        if (txtRazaoSocial.getText().isEmpty()) {
            ...
            if (cont.verificaEmpresaRepetidaRazaoSocial(txtRazaoSocial.getText()) == true && empresa.getRazao_social().equals(txtRazaoSocial.getText()) == false) {
                JOptionPane.showMessageDialog(null, "A empresa cuja razão social é "+txtRazaoSocial.getText()+" já está cadastrada!", "Atenção", JOptionPane.WARNING_MESSAGE);
                txtRazaoSocial.selectAll();
                txtRazaoSocial.grabFocus();
            } else if (cont.verificaEmpresaRepetidaNomeFantasia(txtNomeFantasia.getText()) == true && empresa.getNome_fantasia().equals(txtNomeFantasia.getText()) == false) {
                JOptionPane.showMessageDialog(null, "A empresa cujo nome fantasia é "+txtNomeFantasia.getText()+" já está cadastrada!", "Atenção", JOptionPane.WARNING_MESSAGE);
                ...
                int result = cont.updateEmpresa(empresa);
                if (result == 1) {
                    JOptionPane.showMessageDialog(null, "Empresa "+txtRazaoSocial.getText()+" editada com sucesso!", "ATENÇÃO", JOptionPane.INFORMATION_MESSAGE);
                    editou = true;
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Falha ao tentar editar a empresa "+txtRazaoSocial.getText()+"!", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
