 ...
 * @author Marcos
 */
public class FinanceiroSetorEditar extends JDialog implements ActionListener {
    ...
    private FinanceiroSetorClasse setor;
    
    public boolean editou = false;
    
    public FinanceiroSetorEditar(FinanceiroSetorClasse setor) {
        ...
        txtNome.setText(this.setor.getNome());
        ...
        lblTipo2 = new JLabel();
        lblTipo2.setText(this.setor.getTipo());
    ...
    public void salvar() {
        if (txtNome.getText().isEmpty()) {
            ...
            if (cont.verificaSetorRepetido(txtNome.getText()) == true && this.setor.getNome().equals(txtNome.getText()) == false) {
                ...
                txtNome.selectAll();JOptionPane.showMessageDialog(null, setor.getNome());
                txtNome.grabFocus();
            } else {
                ...
                if (result == 1) {
                    JOptionPane.showMessageDialog(null, "Setor financeiro "+txtNome.getText()+" editado com sucesso!", "ATENÇÃO", JOptionPane.INFORMATION_MESSAGE);
                    editou = true;
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Falha ao tentar editar o setor financeiro "+txtNome.getText()+"!", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
