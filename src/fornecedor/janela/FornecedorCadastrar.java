 ...
 * @author Marcos
 */
public class FornecedorCadastrar extends JDialog implements ActionListener {
    ...
    public FornecedorCadastrar() throws ParseException {
    ...
    public void salvar() {
        if (txtRazaoSocial.getText().isEmpty()) {
            ...
            if (cont.verificaFornecedorRepetidoRazaoSocial(txtRazaoSocial.getText()) == true) {
                ...
                txtRazaoSocial.grabFocus();
            } else if (cont.verificaFornecedorRepetidoNomeFantasia(txtNomeFantasia.getText()) == true) {
                ...
                fornecedor.setId_Pais(lista_paises.get(comboPais.getSelectedIndex()).getId());
                fornecedor.setInscricao_estadual(txtInscricaoEstadual.getText());
                fornecedor.setObservacao(txtObservacao.getText());
                
                int result = cont.addFornecedor(fornecedor);
                if (result == 1) {
                    JOptionPane.showMessageDialog(null, "Fornecedor "+txtRazaoSocial.getText()+" cadastrado com sucesso!", "ATENÇÃO", JOptionPane.INFORMATION_MESSAGE);
                    cadastrou = true;
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Falha ao tentar cadastrar o fornecedor "+txtRazaoSocial.getText()+"!", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
