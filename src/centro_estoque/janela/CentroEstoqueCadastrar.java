 ...
 * @author Marcos
 */
public class CentroEstoqueCadastrar extends JDialog implements ActionListener {
    ...
    public void salvar() {
        if (txtNome.getText().isEmpty()) {
            ...
            if (cont.verificaCentroEstoqueRepetido(txtNome.getText()) == true) {
                ...
                int result = cont.addCentroEstoque(classe);
                if (result == 1) {
                    JOptionPane.showMessageDialog(null, "Centro de estoque "+txtNome.getText()+" cadastrado com sucesso!", "ATENÇÃO", JOptionPane.INFORMATION_MESSAGE);
                    cadastrou = true;
                    dispose();
                } else {
                    JOptionPane.showMessageDialog(null, "Falha ao tentar cadastrar o centro de estoque "+txtNome.getText()+"!", "ATENÇÃO", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    }
