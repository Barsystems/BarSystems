 ...
 * @author Marcos
 */
public class ServicoSetorEditar extends JDialog implements ActionListener {
    ...
    private ServicoSetorClasse setor;
    
    public boolean editou = false;
    
    public ServicoSetorEditar(ServicoSetorClasse setor) {
        this.setor = setor;
