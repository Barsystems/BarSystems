...
import servico_setor.table.ServicoSetorTableModel;
 ...
 * @author Marcos
 */
public class ServicoSetorJanela extends JPanel implements ActionListener, KeyListener {
    ...
    private List<ServicoSetorClasse> user;
    
    private JTabbedPane painel_principal;
    
    public ServicoSetorJanela(UsuarioClasse user, int width, JTabbedPane painel_principal) {
        ...
        lblTitulo.setText("MANUTENÇÃO DO CADASTRO DE SETORES DE SERVIÇOS");
    ...
    public void refreshTable() {
        user = new ServicoSetorController().refreshTabela(txtPesquisar.getText());
        if (user != null) {
            tabela.setModel(new ServicoSetorTableModel(user));
    ...
    public void novoUsuario() {
        ServicoSetorCadastrar cadastrar = new ServicoSetorCadastrar();
    ...
    public void editarUsuario() {
        ServicoSetorEditar editar = new ServicoSetorEditar(user.get(tabela.getSelectedRow()));
    ...
    public void excluirUsuario() {
        ServicoSetorClasse setor = user.get(tabela.getSelectedRow());
        ServicoSetorExcluir excluir = new ServicoSetorExcluir();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source == btnNovo) {
            ...
            int index = verifica.verificaMenuAberto(painel_principal, "Cadastro de setores de serviços");
